...
namespace security
{
    public class Action
    {
        public static bool login(string username, string password,bool crypt,Key key) // this strings MUST be encrypted so,, we must ask for key in case we use always a random one
        ...
        public static bool webrequest(string user,string psw,Key key)
        {
        ...
        public static bool procces(string resp,Key key)
        {
